...
namespace DoAnLTW.Migrations
{
    ...
    [Migration("20250405044355_updatePromotion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoAnLTW.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoAnLTW.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoAnLTW.Models.ProductPromotion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoAnLTW.Models.ProductSpecification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoAnLTW.Models.Promotion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoAnLTW.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoAnLTW.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("DoAnLTW.Models.ShoppingCart", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("DoAnLTW.Models.Order", b =>
                {
                    b.HasOne("DoAnLTW.Models.Promotion", null)
                        .WithMany("Orders")
                        .HasForeignKey("PromotionId");

                    b.HasOne("DoAnLTW.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("DoAnLTW.Models.ProductPromotion", b =>
                {
                    ...
                    b.HasOne("DoAnLTW.Models.Promotion", "Promotion")
                        .WithMany("ProductPromotions")
                        .HasForeignKey("PromotionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
